...
<form:form id="joinMem" action="/joinMember2" modelAttribute="memberVO" method="post">
						...
						<table style="width: 70%">
							...
							<tbody>
								...
								<tr>
									...
									<td><form:password id="memPass" path="memPass"/></td>
								</tr>
								<tr>
									<th><span>닉네임</span></th>
									<td><input id="memNick" type="text" placeholder=""></td>
								</tr>
								
								<tr class="email">
									<th><span>이메일</span></th>
									<td>
										<form:input id="memEmail" path="memEmail"/>
										<input type="button" id="mailChk" value="메일인증" />
									</td>
								</tr>
					</table>
				</div> <!-- form_txtInput E -->
									...
									<div class="btn_wrap" style="margin: 0 120px"> 
										<a href="#" id="joinMem" onclick="DosignUp()">회원가입</a>
									 </div> 
...
<%-- 
<label for="memId">	아이디	</label><form:input path="memId"/>
 					<form:errors id="memId" path="memId"/>
			비밀번호 <form:password id="memPass" path="memPass"/>
				<form:errors path="memPass"/>
				이메일주소 <form:input id="memEmail" path="memEmail"/>
				<form:errors path="memEmail"/>
닉네임<form:input id="memNick" path="memNick" />
				<form:errors path="memNick"/>
<	<a href="#" id="joinMem" onclick="DosignUp()">회원가입</a>
...
.btn_wrap{text-align:center; margin:60px 10 40px;}
...
function DosignUp() {
    ...
    var userpwd = $("#memPass").val();
    var username = $("#memNick").val();
